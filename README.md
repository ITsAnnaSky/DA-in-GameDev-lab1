...
AND:
![image](https://user-images.githubusercontent.com/103886479/204091237-863213a1-05d5-4524-a2ba-57a678d6a203.png)
...
В данной лабораторной работе мы изучили работу прецептрона, узнали для чего нужно значение Total Error, также увидели на практике обучаемость прецептрона Узнали, что возможности однослойного прецептрона ограничены и при более сложных задачах он нуждается в расширении. Увидели, как в зависимости от поставленной задачи и количества попыток изменяется значение TotalError.
